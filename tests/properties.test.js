...
import Properties from '../client/components/properties.jsx';

const title = 'Test Properties Component';
let dataSample = {
...
let wrapped = shallow(<Properties data={dataSample}/>);
describe ('Properties Component', () => {
  it('should render the Properties Component correctly', () => {
